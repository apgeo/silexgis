...
export const groups = {
  ...
  imports: [
    ...
    'SpeleolocTripImportTests', 'StagedImportTests',
  ],
  jobs: [
...
export const crossCutting = {
 ...
 'DocumentMetadataTests', 'EntrancePlacementGuardTests', 'EventAuthoringTests',
 ...
 'TripReportTemplateTests', 'TripStatisticsTests', 'TripTrackingPicturesTests',
 'TripTrackingPublicationTests',
 ...
 'HypsometryTests', 'KarstLinkExportTests', 'MapDensityTests', 'MapPointPatternTests',
 'PhotoBytesProtectionTests', 'PhotoImportTests', 'PolygonMorphometryTests',
 'ProtectionDepthTests', 'RegistryStatisticsTests', 'ResLinkApiTests',
 ...
 'SurveyModelTests', 'SurveySegmentSubstrateTests', 'SurveySourceTests',
 'SyncPageSizeTests', 'SyncProtocolTests', 'SyncUploadTests', 'TerrainProbeTests',
 ...
 'TripMapDerivedPositionTests', 'TripMeetingPointTests', 'TripPastTrackTests',
 'TripPlanNotificationTests',

...
export const crossCutting = {
 ...
 'TripMapDerivedPositionTests', 'TripMeetingPointTests', 'TripPlanNotificationTests',
 'TripReportDocumentTests', 'TripRoleLinkUnitOfWorkTests', 'TripStatisticsTests',
 'TripStatsTests', 'TripTrackingPublicationTests', 'TripTrackingTests', 'WorkAreaTests',

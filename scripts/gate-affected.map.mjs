...
export const groups = {
  trips: [
    ...
    'TripMeetingPointTests', 'TripParticipantRoleVocabularyTests', 'TripPlanNotificationTests',
    'TripPromotionTests', 'TripReportDocumentTests', 'TripReportTemplateTests',
    'TripRoleLinkUnitOfWorkTests', 'TripSectionSchemaTests', 'TripStatisticsTests',
  ...
  caves: [
    'AssociationDisclosureTests', 'CaveDomainTests', 'CenterlineTests', 'ProtectionDepthTests',
  ...
  me: ['AccountEmailTests', 'AccountSettingsTests', 'TwoFactorChannelTests', 'UiDefaultsTests'],
  users: [
    'AuthFlowTests', 'EmailVerificationTests', 'ExternalAuthTests', 'MfaAndRateLimitTests',
    'ProfileVisibilityTests', 'TwoFactorChannelTests',
  ],
  resLinks: ['ResLinkApiTests', 'ResLinkProtectionFloorTests'],
  ...
  taxonomies: [
    'ExpeditionRosterRoleVocabularyTests', 'TermRuleSetTests',
...
export const crossCutting = {
  ...
  permissionClasses: [
    ...
    'CabinetApiTests', 'CaveDomainTests', 'CaverRosterTests', 'CenterlineTests',
    'ChecklistAuthoringTests', 'DocumentAccessApiTests', 'DocumentCommentApiTests',
    'DocumentLanguageTests', 'DocumentMetadataTests', 'ExpeditionMembershipTests',
    ...
    'FileAttachmentTests', 'GeofileTests', 'MapViewTests', 'PhotoImportTests',
    'ResLinkApiTests', 'SeededGroupUpgradeTests', 'StagedImportTests', 'SurveyModelTests',
    'TermRuleSetTests', 'TextExtractionPipelineTests', 'TripAndTagTests',
    'TripAttendanceLimitTests', 'TripCalloutStandDownTests', 'TripChecklistTickTests',
    'TripInvitationTests', 'TripParticipantRoleVocabularyTests', 'TripPromotionTests',
  ...
  locationClasses: [
    ...
    'GeoreferencedMapTests', 'HistoryTests', 'PhotoBytesProtectionTests', 'PhotoImportTests',
    'ProtectionDepthTests', 'ResLinkApiTests', 'ResLinkProtectionFloorTests',
    'StagedImportTests', 'SurveyModelTests', 'TripAndTagTests', 'TripCalloutSweepTests',

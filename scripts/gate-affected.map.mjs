...
export const groups = {
  ...
  caves: [
    ...
    'CenterlineTests', 'HypsometryTests', 'ProtectionDepthTests', 'StructureComparisonTests',
...
export const crossCutting = {
 ...
 'BulkImportTests', 'CabinetApiTests', 'CaveDomainTests', 'CaveExternalIdTests',
 'CaveOverburdenTests', 'CaveQrPublicationTests', 'CaverRosterTests',
 'CavingGroupAnnouncementTests', 'CenterlineTests', 'ChecklistAuthoringTests',
 'DocumentAccessApiTests', 'DocumentCommentApiTests', 'DocumentLanguageTests',
 'DocumentMetadataTests', 'EventAuthoringTests', 'EventInvitationTests', 'EventLifecycleTests',
 ...
 'FileAttachmentTests', 'GeofileTests', 'HypsometryTests', 'ImmichPhotoLibraryTests',
 'MapViewTests', 'NotificationHealthTests', 'PhotoImportTests',
 ...
 'ResLinkApiTests', 'SeededGroupUpgradeTests', 'SpeologieCatalogueTests', 'StagedImportTests',
 ...
 'PolygonMorphometryTests', 'ProtectionDepthTests', 'RegistryStatisticsTests',
 'ResLinkApiTests', 'ResLinkProtectionFloorTests', 'SpeleoLocDevSeedTests',
 'SpeologieCatalogueTests', 'StagedImportTests', 'StructureComparisonTests',
 'SurveyCompilationTests', 'SurveyGraphTests', 'SurveyModelTests',
 'SurveySegmentSubstrateTests', 'SurveySourceTests', 'SyncPageSizeTests', 'SyncProtocolTests',
 'SyncUploadTests', 'TerrainProbeTests', 'TripAndTagTests', 'TripCalloutSweepTests',
 'TripCaveReachTests', 'TripImportCommitTests', 'TripImportPreviewResolutionTests',

...
export const groups = {
  ...
  photoLibraries: [
    'PhotoLibraryEndpointTests', 'PhotoLibraryFeatureRequestTests', 'PhotoLibraryProbeTests',
    'PhotoLibraryTests',
  ],
  ...
  surveys: [
    'CaveOverburdenTests', 'CavePassageShapeTests', 'CaveSurveyStatisticsTests', 'HypsometryTests', 'StructureComparisonTests', 'SurveyFormatReaderTests', 'SurveyGraphExtractorTests', 'SurveyGraphTests', 'SurveyMeshTests', 'SurveyModelTests', 'SurveyPlacementTests', 'SurveySegmentSubstrateTests', 'SurveySourceTests', 'KarstnetGoldenTests', 'SurveyTopologyTests',
  ],
...
export const crossCutting = {
  ...
  permissionClasses: [
    ...
    'MapViewTests', 'NotificationHealthTests', 'PhotoImportTests', 'PhotoLibraryEndpointTests',
    'PhotoLibraryTests', 'ResLinkApiTests', 'SeededGroupUpgradeTests', 'SpeologieCatalogueTests',
    'StagedImportTests', 'SurveyModelTests', 'SurveySourceTests', 'SyncSetTests',
    'TermRuleSetTests', 'TerrainActivationTests', 'TerrainBuildApiTests',
    'TerrainBuildPipelineTests', 'TerrainProbeTests', 'TerrainSourceTests',
    'TextExtractionPipelineTests', 'TripAndTagTests', 'TripAttendanceLimitTests',
    'TripCalloutStandDownTests', 'TripChecklistTickTests', 'TripImportCommitTests',
    'TripImportSessionTests', 'TripInvitationTests', 'TripParticipantRoleVocabularyTests',

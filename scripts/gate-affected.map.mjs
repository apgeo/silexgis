...
export const groups = {
  ...
  surveys: [
    'CaveSurveyStatisticsTests', 'SurveyFormatReaderTests', 'SurveyGraphExtractorTests',
...
export const crossCutting = {
  ...
  locationClasses: [
    ...
    'ResLinkProtectionFloorTests', 'SpeleoLocDevSeedTests', 'StagedImportTests',
    'SurveyGraphTests', 'SurveyModelTests', 'SurveySegmentSubstrateTests', 'SurveySourceTests',
    'SyncPageSizeTests', 'SyncProtocolTests', 'SyncUploadTests', 'TripAndTagTests',

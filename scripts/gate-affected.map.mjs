...
export const crossCutting = {
  ...
  permissionClasses: [
    ...
    'FileAttachmentTests', 'GeofileTests', 'HypsometryTests', 'MapViewTests',
    'NotificationHealthTests',
  ...
  locationClasses: [
    ...
    'GeoreferencedMapTests', 'HistoryTests', 'HypsometryTests', 'PhotoBytesProtectionTests',
    ...
    'StructureComparisonTests', 'SurveyGraphTests', 'SurveyModelTests',
    'SurveySegmentSubstrateTests', 'SurveySourceTests',

...
##  *** put a primary key on the first place 
  ...
  $sql="SELECT 	id, 	name, 	symbol_path	 	FROM 	feature_types"; //.(!empty($filter_start_time_min) || !empty($filter_start_time_max) ? " WHERE 1 = 1 ".getSQLFilterString("time", $filter_start_time_min, $filter_start_time_max, "") : ""); 

...
function setLanguage(){ 
    ...
    $lang['export_message'] = "<label class=\"default_class_label\">O arquivo _FILE_ está pronto. Depois que terminar de baixar,</label> <a class=\"default_class_error_message\" href=\"javascript: window.close();\">feche esta janela</a>.";
    $lang['field'] = "Campo"; 

...
abstract class BaseFilesPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (FilesPeer::ID, FilesPeer::FILE_NAME, FilesPeer::ID_USER, FilesPeer::ADD_TIME, FilesPeer::TYPE, FilesPeer::SIZE, FilesPeer::MD5_HASH, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (FilesPeer::ID => 0, FilesPeer::FILE_NAME => 1, FilesPeer::ID_USER => 2, FilesPeer::ADD_TIME => 3, FilesPeer::TYPE => 4, FilesPeer::SIZE => 5, FilesPeer::MD5_HASH => 6, ),
    ...
    protected static $enumValueSets = array(
        FilesPeer::TYPE => array(
            FilesPeer::TYPE_GPX,
            FilesPeer::TYPE_KML,
            FilesPeer::TYPE_UNDEFINED,
        ),
    );
    ...
    {
      return FilesPeer::$enumValueSets;
    }
    ...
    {
        $valueSets = FilesPeer::getValueSets();
    ...
    {
        $values = FilesPeer::getValueSet($colname);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FilesPeer::ID_USER);
            $criteria->addSelectColumn(FilesPeer::ADD_TIME);
            $criteria->addSelectColumn(FilesPeer::TYPE);

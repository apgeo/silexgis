...
abstract class BasePoints extends BaseObject implements Persistent
{
    ...
    public function setCoords($v)
    {
        ...
        if ($this->coords !== $v) {
            $this->coords = $v;
            $this->modifiedColumns[] = PointsPeer::COORDS;
        }
    ...
    /**
     * Set the value of [geom] column.
     *
     * @param  string $v new value
     * @return Points The current object (for fluent API support)
     */
    public function setGeom($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->geom !== $v) {
            $this->geom = $v;
            $this->modifiedColumns[] = PointsPeer::GEOM;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->geom = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->spatial_geometry = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->resetModified();
            ...
            return $startcol + 19; // 19 = PointsPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PointsPeer::COORDS)) {
        ...
        if ($this->isColumnModified(PointsPeer::GEOM)) {
            $modifiedColumns[':p' . $index++]  = '`geom`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`_id_point_type`':
                        ...
                        break;
                    case '`geom`':
                        $stmt->bindValue($identifier, $this->geom, PDO::PARAM_STR);
                        break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[17] => $this->getGeom(),
            $keys[18] => $this->getSpatialGeometry(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[17], $arr)) $this->setGeom($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setSpatialGeometry($arr[$keys[18]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PointsPeer::COORDS)) $criteria->add(PointsPeer::COORDS, $this->coords);
        ...
        if ($this->isColumnModified(PointsPeer::GEOM)) $criteria->add(PointsPeer::GEOM, $this->geom);

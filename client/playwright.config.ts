  ...
  projects: [
    {
      ...
      name: 'desktop',
      testMatch:
        /(smoke|settings|permission-groups|documents|uploads|gallery|reslinks|trips|expeditions|scene3d|vector-import|photo-import|panel|consoleGuard|errorReporting)\.spec\.ts/,
    },
    {

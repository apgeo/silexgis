  ...
  projects: [
    {
      ...
      name: 'desktop',
      testMatch:
        /(smoke|settings|permission-groups|documents|uploads|gallery|reslinks|trips|scene3d|terrain|vector-import|photo-import|panel|consoleGuard|errorReporting|notifications|notification-health|announcements|calendar|expeditions)\.spec\.ts/,
    },
    {

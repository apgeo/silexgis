  ...
  projects: [
    {
      ...
      name: 'desktop',
      testMatch:
        /(smoke|settings|permission-groups|documents|uploads|gallery|reslinks|trips|scene3d|vector-import|photo-import|panel|consoleGuard|errorReporting)\.spec\.ts/,
    },
    {

  ...
  projects: [
    {
      ...
      name: 'desktop',
      testMatch:
        /(smoke|settings|permission-groups|documents|uploads|gallery|notifications|notification-health|announcements|calendar|reslinks|trips|expeditions|scene3d|vector-import|photo-import|panel|consoleGuard|errorReporting)\.spec\.ts/,
    },
    {

  ...
  projects: [
    {
      ...
      name: 'desktop',
      testMatch:
        /(smoke|settings|permission-groups|documents|uploads|gallery|reslinks|annotated-text|trips|scene3d|terrain|vector-import|trip-import|trip-list|trip-map|trip-stats|photo-import|panel|qr-landing|consoleGuard|errorReporting|notifications|notification-health|announcements|calendar|expeditions|survey-extraction|survey-sources|survey-quality|cave-statistics|doline-morphometry|speologie-catalogue|cave-levels|cave-morphometry|karst-density|overburden-profile|photo-library-pictures|photo-library-health|terrain-derivatives)\.spec\.ts/,
    },
    {

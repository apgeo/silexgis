  ...
  projects: [
    {
      ...
      name: 'desktop',
      testMatch:
        /(smoke|settings|permission-groups|documents|uploads|gallery|reslinks|annotated-text|trips|scene3d|terrain|vector-import|trip-import|trip-list|photo-import|panel|qr-landing|consoleGuard|errorReporting|notifications|notification-health|announcements|calendar|expeditions|survey-extraction|survey-sources|cave-statistics|doline-morphometry|speologie-catalogue|cave-levels)\.spec\.ts/,
    },
    {

...
function setLanguage(){ 
    ...
    $lang['export_message'] = "<label class=\"default_class_label\">Het bestand _FILE_ is klaar. Wanneer u klaar bent met downloaden,</label> <a class=\"default_class_error_message\" href=\"javascript: window.close();\">sluit dit venster</a>.";
    $lang['field'] = "Veld"; 

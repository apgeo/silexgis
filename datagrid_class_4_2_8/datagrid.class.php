...
Class DataGrid
{
    ...
    // Get current Id
    //--------------------------------------------------------------------------
    public /*protected */ function GetCurrentId(){
    ...
    protected function GetFieldValueByType($field_value, $ind, $row, $field_name="", $m_field_req_type=""){
        ...
        if($this->mode === "view"){
            if(array_key_exists($field_name, $this->columns_view_mode)){
				...
				//x if(function_exists($field_property_on_item_created)) $field_value = $field_property_on_item_created($field_value, &$field_property_type);
    ...
    protected function StrToLower($str){
        if($this->lang_name == "en"){
            ...
            return strtolower($str);      // mb_StrToLower($str, mb_detect_encoding($str));      
        }       
    }

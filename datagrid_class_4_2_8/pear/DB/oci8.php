...
class DB_oci8 extends DB_common
{
    ...
    function numRows($result)
    {
        ...
        // old if ($this->options['portability'] & DB_PORTABILITY_NUMROWS &&
        //    $result === $this->last_stmt)
        if (DB_PORTABILITY_NUMROWS && $result === $this->last_stmt) 
        {
    ...
    function tableInfo($result, $mode = null)
    {
        ...
        if (is_string($result)) {
            ...
            // these lines are commented by suggestion of stchong 9.08.2008 (NOT checked yet)

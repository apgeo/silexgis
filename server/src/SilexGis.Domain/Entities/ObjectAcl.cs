...
/// <summary>ACL grant subject: a single user or a whole caving group. Stored as smallint.</summary>
...
/// roles/ownership and caving group membership). The target is EITHER a feature (real FK) OR a
...
/// (e.g. a user grant plus a caving group grant). Grants are audited — ViewExactLocation grants
/// especially matter.
///

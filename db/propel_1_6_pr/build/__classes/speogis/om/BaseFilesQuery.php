 ...
 * @method FilesQuery orderByFileType($order = Criteria::ASC) Order by the file_type column
 ...
 * @method FilesQuery orderByMimeType($order = Criteria::ASC) Order by the mime_type column
 *
 ...
 * @method FilesQuery groupByFileType() Group by the file_type column
 * @method FilesQuery groupBySize() Group by the size column
 * @method FilesQuery groupByMd5Hash() Group by the md5_hash column
 * @method FilesQuery groupByMimeType() Group by the mime_type column
 *
 ...
 * @method Files findOneByUserId(string $user_id) Return the first Files filtered by the user_id column
 * @method Files findOneByAddTime(string $add_time) Return the first Files filtered by the add_time column
 * @method Files findOneByFileType(string $file_type) Return the first Files filtered by the file_type column
 ...
 * @method Files findOneByMimeType(string $mime_type) Return the first Files filtered by the mime_type column
 *
 ...
 * @method array findByUserId(string $user_id) Return Files objects filtered by the user_id column
 * @method array findByAddTime(string $add_time) Return Files objects filtered by the add_time column
 * @method array findByFileType(string $file_type) Return Files objects filtered by the file_type column
 ...
 * @method array findByMimeType(string $mime_type) Return Files objects filtered by the mime_type column
 *
...
abstract class BaseFilesQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `file_name`, `user_id`, `add_time`, `file_type`, `size`, `md5_hash`, `mime_type` FROM `files` WHERE `id` = :p0';
        try {
    ...
    public function filterByFileType($fileType = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FilesPeer::FILE_TYPE, $fileType, $comparison);
    }
    ...
    public function filterByMimeType($mimeType = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FilesPeer::MIME_TYPE, $mimeType, $comparison);
    }

...
/**
 * Base class that represents a row from the 'pointsxx' table.
 *
 *
 *
 * @package    propel.generator.speogis.om
 */
abstract class BasePointsxx extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PointsxxPeer';
    ...
    /**
     * Initializes internal state of BasePointsxx object.
     * @see        applyDefaults()
     */
     ...
     * @return Pointsxx The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PointsxxPeer::ID;
        }
    ...
    public function setLat($v)
    {
        ...
        if ($this->lat !== $v) {
            $this->lat = $v;
            $this->modifiedColumns[] = PointsxxPeer::LAT;
        }
    ...
    public function setLong($v)
    {
        ...
        if ($this->long !== $v) {
            $this->long = $v;
            $this->modifiedColumns[] = PointsxxPeer::LONG;
        }
    ...
    public function setElevation($v)
    {
        ...
        if ($this->elevation !== $v) {
            $this->elevation = $v;
            $this->modifiedColumns[] = PointsxxPeer::ELEVATION;
        }
    ...
    public function setCoords($v)
    {
        ...
        if ($this->coords !== $v) {
            $this->coords = $v;
            $this->modifiedColumns[] = PointsxxPeer::COORDS;
        }
    ...
    public function setGpxName($v)
    {
        ...
        if ($this->gpx_name !== $v) {
            $this->gpx_name = $v;
            $this->modifiedColumns[] = PointsxxPeer::GPX_NAME;
        }
    ...
    public function setGpxSym($v)
    {
        ...
        if ($this->gpx_sym !== $v) {
            $this->gpx_sym = $v;
            $this->modifiedColumns[] = PointsxxPeer::GPX_SYM;
        }
    ...
    public function setGpxType($v)
    {
        ...
        if ($this->gpx_type !== $v) {
            $this->gpx_type = $v;
            $this->modifiedColumns[] = PointsxxPeer::GPX_TYPE;
        }
    ...
    public function setGpxCmt($v)
    {
        ...
        if ($this->gpx_cmt !== $v) {
            $this->gpx_cmt = $v;
            $this->modifiedColumns[] = PointsxxPeer::GPX_CMT;
        }
    ...
    public function setGpxSat($v)
    {
        ...
        if ($this->gpx_sat !== $v) {
            $this->gpx_sat = $v;
            $this->modifiedColumns[] = PointsxxPeer::GPX_SAT;
        }
    ...
    public function setGpxFix($v)
    {
        ...
        if ($this->gpx_fix !== $v) {
            $this->gpx_fix = $v;
            $this->modifiedColumns[] = PointsxxPeer::GPX_FIX;
        }
    ...
    public function setGpxTime($v)
    {
        ...
        if ($this->gpx_time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PointsxxPeer::GPX_TIME;
            }
    ...
    public function setType($v)
    {
        ...
        if ($this->_type !== $v) {
            $this->_type = $v;
            $this->modifiedColumns[] = PointsxxPeer::_TYPE;
        }
    ...
    public function setDetails($v)
    {
        ...
        if ($this->_details !== $v) {
            $this->_details = $v;
            $this->modifiedColumns[] = PointsxxPeer::_DETAILS;
        }
    ...
    public function setAddedByUserId($v)
    {
        ...
        if ($this->added_by_user_id !== $v) {
            ...
            $this->modifiedColumns[] = PointsxxPeer::ADDED_BY_USER_ID;
        }
    ...
    public function setAddTime($v)
    {
        ...
        if ($this->add_time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PointsxxPeer::ADD_TIME;
            }
        } // if either are not null
    ...
    public function setIdPointType($v)
    {
        ...
        if ($this->_id_point_type !== $v) {
            ...
            $this->modifiedColumns[] = PointsxxPeer::_ID_POINT_TYPE;
        }
    ...
    public function setSpatialGeometry($v)
    {
        ...
        if ($this->spatial_geometry !== $v) {
            ...
            $this->modifiedColumns[] = PointsxxPeer::SPATIAL_GEOMETRY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->coords = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->gpx_name = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->gpx_sym = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->gpx_type = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->gpx_cmt = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->gpx_sat = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            $this->gpx_fix = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->gpx_time = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->_type = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
            $this->_details = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->added_by_user_id = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->add_time = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->_id_point_type = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->spatial_geometry = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->resetModified();
            ...
            return $startcol + 18; // 18 = PointsxxPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Pointsxx object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PointsxxPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PointsxxQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PointsxxPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PointsxxPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PointsxxPeer::LAT)) {
            $modifiedColumns[':p' . $index++]  = '`lat`';
        }
        if ($this->isColumnModified(PointsxxPeer::LONG)) {
            $modifiedColumns[':p' . $index++]  = '`long`';
        }
        if ($this->isColumnModified(PointsxxPeer::ELEVATION)) {
            $modifiedColumns[':p' . $index++]  = '`elevation`';
        }
        if ($this->isColumnModified(PointsxxPeer::COORDS)) {
            $modifiedColumns[':p' . $index++]  = '`coords`';
        }
        if ($this->isColumnModified(PointsxxPeer::GPX_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`gpx_name`';
        }
        if ($this->isColumnModified(PointsxxPeer::GPX_SYM)) {
            $modifiedColumns[':p' . $index++]  = '`gpx_sym`';
        }
        if ($this->isColumnModified(PointsxxPeer::GPX_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`gpx_type`';
        }
        if ($this->isColumnModified(PointsxxPeer::GPX_CMT)) {
            $modifiedColumns[':p' . $index++]  = '`gpx_cmt`';
        }
        if ($this->isColumnModified(PointsxxPeer::GPX_SAT)) {
            $modifiedColumns[':p' . $index++]  = '`gpx_sat`';
        }
        if ($this->isColumnModified(PointsxxPeer::GPX_FIX)) {
            $modifiedColumns[':p' . $index++]  = '`gpx_fix`';
        }
        if ($this->isColumnModified(PointsxxPeer::GPX_TIME)) {
            $modifiedColumns[':p' . $index++]  = '`gpx_time`';
        }
        if ($this->isColumnModified(PointsxxPeer::_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`_type`';
        }
        if ($this->isColumnModified(PointsxxPeer::_DETAILS)) {
            $modifiedColumns[':p' . $index++]  = '`_details`';
        }
        if ($this->isColumnModified(PointsxxPeer::ADDED_BY_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`added_by_user_id`';
        }
        if ($this->isColumnModified(PointsxxPeer::ADD_TIME)) {
            $modifiedColumns[':p' . $index++]  = '`add_time`';
        }
        if ($this->isColumnModified(PointsxxPeer::_ID_POINT_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`_id_point_type`';
        }
        if ($this->isColumnModified(PointsxxPeer::SPATIAL_GEOMETRY)) {
            $modifiedColumns[':p' . $index++]  = '`spatial_geometry`';
        }

        $sql = sprintf(
            'INSERT INTO `pointsxx` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PointsxxPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PointsxxPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Pointsxx'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Pointsxx'][$this->getPrimaryKey()] = true;
        $keys = PointsxxPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getLat(),
            $keys[2] => $this->getLong(),
            $keys[3] => $this->getElevation(),
            $keys[4] => $this->getCoords(),
            $keys[5] => $this->getGpxName(),
            $keys[6] => $this->getGpxSym(),
            $keys[7] => $this->getGpxType(),
            $keys[8] => $this->getGpxCmt(),
            $keys[9] => $this->getGpxSat(),
            $keys[10] => $this->getGpxFix(),
            $keys[11] => $this->getGpxTime(),
            $keys[12] => $this->getType(),
            $keys[13] => $this->getDetails(),
            $keys[14] => $this->getAddedByUserId(),
            $keys[15] => $this->getAddTime(),
            $keys[16] => $this->getIdPointType(),
            $keys[17] => $this->getSpatialGeometry(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setCoords($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setGpxName($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setGpxSym($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setGpxType($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setGpxCmt($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setGpxSat($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setGpxFix($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setGpxTime($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setType($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setDetails($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setAddedByUserId($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setAddTime($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setIdPointType($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setSpatialGeometry($arr[$keys[17]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PointsxxPeer::ID)) $criteria->add(PointsxxPeer::ID, $this->id);
        if ($this->isColumnModified(PointsxxPeer::LAT)) $criteria->add(PointsxxPeer::LAT, $this->lat);
        if ($this->isColumnModified(PointsxxPeer::LONG)) $criteria->add(PointsxxPeer::LONG, $this->long);
        if ($this->isColumnModified(PointsxxPeer::ELEVATION)) $criteria->add(PointsxxPeer::ELEVATION, $this->elevation);
        if ($this->isColumnModified(PointsxxPeer::COORDS)) $criteria->add(PointsxxPeer::COORDS, $this->coords);
        if ($this->isColumnModified(PointsxxPeer::GPX_NAME)) $criteria->add(PointsxxPeer::GPX_NAME, $this->gpx_name);
        if ($this->isColumnModified(PointsxxPeer::GPX_SYM)) $criteria->add(PointsxxPeer::GPX_SYM, $this->gpx_sym);
        if ($this->isColumnModified(PointsxxPeer::GPX_TYPE)) $criteria->add(PointsxxPeer::GPX_TYPE, $this->gpx_type);
        if ($this->isColumnModified(PointsxxPeer::GPX_CMT)) $criteria->add(PointsxxPeer::GPX_CMT, $this->gpx_cmt);
        if ($this->isColumnModified(PointsxxPeer::GPX_SAT)) $criteria->add(PointsxxPeer::GPX_SAT, $this->gpx_sat);
        if ($this->isColumnModified(PointsxxPeer::GPX_FIX)) $criteria->add(PointsxxPeer::GPX_FIX, $this->gpx_fix);
        if ($this->isColumnModified(PointsxxPeer::GPX_TIME)) $criteria->add(PointsxxPeer::GPX_TIME, $this->gpx_time);
        if ($this->isColumnModified(PointsxxPeer::_TYPE)) $criteria->add(PointsxxPeer::_TYPE, $this->_type);
        if ($this->isColumnModified(PointsxxPeer::_DETAILS)) $criteria->add(PointsxxPeer::_DETAILS, $this->_details);
        if ($this->isColumnModified(PointsxxPeer::ADDED_BY_USER_ID)) $criteria->add(PointsxxPeer::ADDED_BY_USER_ID, $this->added_by_user_id);
        if ($this->isColumnModified(PointsxxPeer::ADD_TIME)) $criteria->add(PointsxxPeer::ADD_TIME, $this->add_time);
        if ($this->isColumnModified(PointsxxPeer::_ID_POINT_TYPE)) $criteria->add(PointsxxPeer::_ID_POINT_TYPE, $this->_id_point_type);
        if ($this->isColumnModified(PointsxxPeer::SPATIAL_GEOMETRY)) $criteria->add(PointsxxPeer::SPATIAL_GEOMETRY, $this->spatial_geometry);
    ...
    {
        $criteria = new Criteria(PointsxxPeer::DATABASE_NAME);
        $criteria->add(PointsxxPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Pointsxx (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Pointsxx Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PointsxxPeer::DEFAULT_STRING_FORMAT);
    }

...
abstract class BaseFiles extends BaseObject implements Persistent
{
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = FilesPeer::USER_ID;
        }
    ...
    public function setAddTime($v)
    {
        ...
        if ($this->add_time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FilesPeer::ADD_TIME;
            }
    ...
    public function setFileType($v)
    {
        ...
        if ($this->file_type !== $v) {
            $this->file_type = $v;
            $this->modifiedColumns[] = FilesPeer::FILE_TYPE;
        }
    ...
    public function setMd5Hash($v)
    {
        ...
        if ($this->md5_hash !== $v) {
            $this->md5_hash = $v;
            $this->modifiedColumns[] = FilesPeer::MD5_HASH;
        }
    ...
    public function setMimeType($v)
    {
        ...
        if ($this->mime_type !== $v) {
            $this->mime_type = $v;
            $this->modifiedColumns[] = FilesPeer::MIME_TYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->file_type = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->size = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->md5_hash = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->mime_type = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = FilesPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FilesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(FilesPeer::FILE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`file_name`';
        }
        if ($this->isColumnModified(FilesPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(FilesPeer::ADD_TIME)) {
            $modifiedColumns[':p' . $index++]  = '`add_time`';
        }
        if ($this->isColumnModified(FilesPeer::FILE_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`file_type`';
        }
        if ($this->isColumnModified(FilesPeer::SIZE)) {
            $modifiedColumns[':p' . $index++]  = '`size`';
        }
        if ($this->isColumnModified(FilesPeer::MD5_HASH)) {
            $modifiedColumns[':p' . $index++]  = '`md5_hash`';
        }
        if ($this->isColumnModified(FilesPeer::MIME_TYPE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FilesPeer::USER_ID)) $criteria->add(FilesPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(FilesPeer::ADD_TIME)) $criteria->add(FilesPeer::ADD_TIME, $this->add_time);
        if ($this->isColumnModified(FilesPeer::FILE_TYPE)) $criteria->add(FilesPeer::FILE_TYPE, $this->file_type);
        if ($this->isColumnModified(FilesPeer::SIZE)) $criteria->add(FilesPeer::SIZE, $this->size);
        if ($this->isColumnModified(FilesPeer::MD5_HASH)) $criteria->add(FilesPeer::MD5_HASH, $this->md5_hash);
        if ($this->isColumnModified(FilesPeer::MIME_TYPE)) $criteria->add(FilesPeer::MIME_TYPE, $this->mime_type);

...
abstract class BaseUsers extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the admin_level field.
     * @var        int
     */
    ...
    /**
     * Get the [admin_level] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [admin_level] column.
     *
    ...
    public function setAdminLevel($v)
    {
        ...
        if ($this->admin_level !== $v) {
            $this->admin_level = $v;
            $this->modifiedColumns[] = UsersPeer::ADMIN_LEVEL;
        }

 ...
 * @method FeaturesQuery orderByProperties($order = Criteria::ASC) Order by the properties column
 * @method FeaturesQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 * @method FeaturesQuery orderByAddTime($order = Criteria::ASC) Order by the add_time column
 * @method FeaturesQuery orderByTags($order = Criteria::ASC) Order by the tags column
 *
 ...
 * @method FeaturesQuery groupByProperties() Group by the properties column
 * @method FeaturesQuery groupByUserId() Group by the user_id column
 * @method FeaturesQuery groupByAddTime() Group by the add_time column
 * @method FeaturesQuery groupByTags() Group by the tags column
 *
 ...
 * @method Features findOneByProperties(string $properties) Return the first Features filtered by the properties column
 * @method Features findOneByUserId(string $user_id) Return the first Features filtered by the user_id column
 * @method Features findOneByAddTime(string $add_time) Return the first Features filtered by the add_time column
 * @method Features findOneByTags(string $tags) Return the first Features filtered by the tags column
 *
 ...
 * @method array findByProperties(string $properties) Return Features objects filtered by the properties column
 * @method array findByUserId(string $user_id) Return Features objects filtered by the user_id column
 * @method array findByAddTime(string $add_time) Return Features objects filtered by the add_time column
 * @method array findByTags(string $tags) Return Features objects filtered by the tags column
 *
...
abstract class BaseFeaturesQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `name`, `point_id`, `description`, `feature_type_id`, `properties`, `user_id`, `add_time`, `tags` FROM `features` WHERE `id` = :p0';
        try {
    ...
    public function filterByProperties($properties = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FeaturesPeer::PROPERTIES, $properties, $comparison);
    }
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(FeaturesPeer::USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(FeaturesPeer::USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FeaturesPeer::USER_ID, $userId, $comparison);
    }
    ...
    public function filterByAddTime($addTime = null, $comparison = null)
    {
        if (is_array($addTime)) {
            ...
            if (isset($addTime['min'])) {
                $this->addUsingAlias(FeaturesPeer::ADD_TIME, $addTime['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($addTime['max'])) {
                $this->addUsingAlias(FeaturesPeer::ADD_TIME, $addTime['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FeaturesPeer::ADD_TIME, $addTime, $comparison);
    }
    ...
    public function filterByTags($tags = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FeaturesPeer::TAGS, $tags, $comparison);
    }

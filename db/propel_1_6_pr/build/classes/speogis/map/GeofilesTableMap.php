...
/**
 * This class defines the structure of the 'geofiles' table.
 *
 *
 *
 ...
 */
class GeofilesTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'speogis.map.GeofilesTableMap';
    ...
    {
        // attributes
        $this->setName('geofiles');
        $this->setPhpName('Geofiles');
        $this->setClassname('Geofiles');
  ...
  2 => 'undefined',
        ...
        $this->addColumn('extract_style', 'ExtractStyle', 'VARCHAR', true, 1, 'b\'1\'');
        // validators
    } // initialize()

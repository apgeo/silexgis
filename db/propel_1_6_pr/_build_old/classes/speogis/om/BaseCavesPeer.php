...
abstract class BaseCavesPeer
{
    ...
    const TYPEID = 'caves.typeId';

    /** the column name for the locationIdentifier field */
    const LOCATIONIDENTIFIER = 'caves.locationIdentifier';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Typeid', 'Locationidentifier', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'typeid', 'locationidentifier', 'description', ),
        BasePeer::TYPE_COLNAME => array (CavesPeer::ID, CavesPeer::NAME, CavesPeer::TYPEID, CavesPeer::LOCATIONIDENTIFIER, CavesPeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'TYPEID', 'LOCATIONIDENTIFIER', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'typeId', 'locationIdentifier', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Typeid' => 2, 'Locationidentifier' => 3, 'Description' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'typeid' => 2, 'locationidentifier' => 3, 'description' => 4, ),
        BasePeer::TYPE_COLNAME => array (CavesPeer::ID => 0, CavesPeer::NAME => 1, CavesPeer::TYPEID => 2, CavesPeer::LOCATIONIDENTIFIER => 3, CavesPeer::DESCRIPTION => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'TYPEID' => 2, 'LOCATIONIDENTIFIER' => 3, 'DESCRIPTION' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'typeId' => 2, 'locationIdentifier' => 3, 'description' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CavesPeer::TYPEID);
            $criteria->addSelectColumn(CavesPeer::LOCATIONIDENTIFIER);
            $criteria->addSelectColumn(CavesPeer::DESCRIPTION);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.typeId');
            $criteria->addSelectColumn($alias . '.locationIdentifier');

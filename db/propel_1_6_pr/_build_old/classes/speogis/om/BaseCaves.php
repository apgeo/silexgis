...
abstract class BaseCaves extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the locationidentifier field.
     * @var        string
     */
    ...
    /**
     * Get the [locationidentifier] column value.
     *
     * @return string
     */
    ...
    public function setTypeid($v)
    {
        ...
        if ($this->typeid !== $v) {
            $this->typeid = $v;
            $this->modifiedColumns[] = CavesPeer::TYPEID;
        }
    ...
    /**
     * Set the value of [locationidentifier] column.
     *
     * @param  string $v new value
     * @return Caves The current object (for fluent API support)
     */
    public function setLocationidentifier($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->locationidentifier !== $v) {
            $this->locationidentifier = $v;
            $this->modifiedColumns[] = CavesPeer::LOCATIONIDENTIFIER;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->typeid = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->locationidentifier = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 5; // 5 = CavesPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CavesPeer::TYPEID)) {
            $modifiedColumns[':p' . $index++]  = '`typeId`';
        }
        if ($this->isColumnModified(CavesPeer::LOCATIONIDENTIFIER)) {
            $modifiedColumns[':p' . $index++]  = '`locationIdentifier`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`name`':
                        ...
                        break;
                    case '`typeId`':
                        $stmt->bindValue($identifier, $this->typeid, PDO::PARAM_STR);
                        break;
                    case '`locationIdentifier`':
                        $stmt->bindValue($identifier, $this->locationidentifier, PDO::PARAM_STR);
                        break;
                    case '`description`':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getLocationidentifier();
                break;
            case 4:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getLocationidentifier(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setLocationidentifier($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setLocationidentifier($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CavesPeer::TYPEID)) $criteria->add(CavesPeer::TYPEID, $this->typeid);
        if ($this->isColumnModified(CavesPeer::LOCATIONIDENTIFIER)) $criteria->add(CavesPeer::LOCATIONIDENTIFIER, $this->locationidentifier);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLocationidentifier($this->getLocationidentifier());

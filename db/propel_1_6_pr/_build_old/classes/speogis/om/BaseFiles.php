...
abstract class BaseFiles extends BaseObject implements Persistent
{
    ...
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[] = FilesPeer::ID_USER;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = FilesPeer::TYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = FilesPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FilesPeer::ID_USER)) $criteria->add(FilesPeer::ID_USER, $this->id_user);
        if ($this->isColumnModified(FilesPeer::ADD_TIME)) $criteria->add(FilesPeer::ADD_TIME, $this->add_time);
        if ($this->isColumnModified(FilesPeer::TYPE)) $criteria->add(FilesPeer::TYPE, $this->type);

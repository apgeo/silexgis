<?php
	...
	*/
	...
	$image->setDescription($pictureData->georeferenced_map_description);
	...
	*/
	...
	try
	{
	$georeferencedMap = new GeoreferencedMaps();
	
	$georeferencedMap->setTitle($pictureData->georeferenced_map_title);
	$georeferencedMap->setDescription($pictureData->georeferenced_map_description);
	$georeferencedMap->setBoundarynorth($pictureData->georeferenced_map_boundary_north);
	$georeferencedMap->setBoundarywest($pictureData->georeferenced_map_boundary_west);
	$georeferencedMap->setBoundarysouth($pictureData->georeferenced_map_boundary_south);
	$georeferencedMap->setBoundaryeast($pictureData->georeferenced_map_boundary_east);
	$georeferencedMap->setImageid($image_id);
	//$georeferencedMap->setEnabled(true);
	
	$georeferencedMap->save();

                ...
                <div class="modal-body">
                    <form id="caveForm" role="form">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#entrances" aria-controls="entrances" role="tab" data-toggle="tab">Entrances</a></li>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form class="fileupload" id="cave_files_fileupload_form" role="form" action="<?=WEBROOT?>/data/uploader/index.php" method="POST" enctype="multipart/form-data">
                                                    <!-- id="fileupload" -->

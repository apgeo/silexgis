...
##  *** set aditional filtering settings
  ...
  $filtering_fields = array(
    ...
    "Utilizator"      =>array("table"=>"users",   "field"=>"username", "source"=>"self", "order"=>"DESC", "operator"=>true, "type"=>"dropdownlist", "case_sensitive"=>false,  "comparison_type"=>"binary"),
    "Parola"      =>array("table"=>"users",   "field"=>"password", "source"=>"self", "order"=>"DESC", "operator"=>true, "type"=>"dropdownlist", "case_sensitive"=>false,  "comparison_type"=>"binary"),
...
##  *** set debug mode & messaging options
    ...
    $vm_columns = array(   
    "username"  =>array("header"=>"Utilizator", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal"),    

...
?>
<script type="text/javascript" src="<?=WEBROOT ?>/scripts/georeferenced_image.js"></script>
<script>
	$(document).ready(function() {
		// this is used only by this page
		$('#add_georeferenced_image').on('click', function(event) {
			addGeoreferencedMap();
		});		
	});
</script>
<b><h3>*{georeferenced_maps_page.page_title}*</h3></b><br/>
<button type="button" class="btn btn-primary" id="add_georeferenced_image" >*{georeferenced_maps_page.btn_add_georeferenced_image}*</button>
<?php
################################################################################   
## +---------------------------------------------------------------------------+
## | 1. Creating & Calling:                                                    | 
...
/*  $sql="SELECT files.id, file_name, user_id, files.add_time, files.file_type as file_type, size, md5_hash, geoobjects_to_files.id, t, username
 ...
 ";*/
  $sql = "SELECT 	georeferenced_maps.id, 	georeferenced_maps.description AS georeferenced_map_description, 	boundary_north, 	boundary_east, 	boundary_south, 	boundary_west, 		image_id, 	enabled, title, file_path, user_id, images.add_time AS image_add_time, thumb_file_path
			FROM 	georeferenced_maps
			INNER JOIN images ON images.id = georeferenced_maps.image_id
...
##  *** set aditional filtering settings
  ...
  $filtering_fields = array(
    ...
    "Title"      =>array("table"=>"georeferenced_maps",   "field"=>"title", "source"=>"self", "order"=>"DESC", "operator"=>true, "type"=>"textbox", "case_sensitive"=>false,  "default_operator"=>"like", "comparison_type"=>"string"),
    //"Time"      =>array("table"=>"georeferenced_maps",   "field"=>"add_time", "source"=>"self", "order"=>"DESC", "operator"=>true, "type"=>"textbox", "case_sensitive"=>false,  "comparison_type"=>"date"),
    ...
    //"Size"      =>array("table"=>"geofiles",   "field"=>"size", "source"=>"self", "operator"=>true, "type"=>"textbox", "case_sensitive"=>false,  "comparison_type"=>"numeric"),
...
##  *** set columns in view mode
  $dgrid->setAutoColumnsInViewMode(false);  
    ...
    $vm_columns = array(   
	"title" => array("header"=>"Title", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),
    "file_path" => array("header"=>"File name", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),
	//thumb_file_path
	//"add_time"  => array("header"=>"Time", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),
	"georeferenced_map_description" => array("header"=>"Description", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),
	
	"boundary_north" => array("header"=>"North", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),
	"boundary_east" => array("header"=>"East", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),
	"boundary_south" => array("header"=>"South", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),
	"boundary_west" => array("header"=>"West", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),

	"enabled" => array("header"=>"Enabled", "type"=>"label", "align"=>"left", "width"=>"20px", "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", "readonly"=>true),
  ...
  //$condition = "files.id = ".$dgrid->f_rid." ";  
    ...
    // $fill_from_array = array("0"=>"No", "1"=>"Yes", "2"=>"Don't know", "3"=>"My be"); /* as "value"=>"option" */
     ...
     $em_columns = array(
        ...
        "title"  =>array("header"=>"Title",    "title"=>"x_", "type"=>"textbox",  "width"=>"160px", "req_type"=>"rt", "readonly"=>false, "view_type"=>"textbox"),	
        "description"  =>array("header"=>"Description",    "title"=>"x_", "type"=>"textbox",  "width"=>"160px", "req_type"=>"rt", "readonly"=>false, "view_type"=>"textbox"),
		"boundary_north"  =>array("header"=>"North",    "title"=>"x_", "type"=>"textbox",  "width"=>"160px", "req_type"=>"rf", "readonly"=>false /*"readonly"=>true*/),      
		"boundary_east"  =>array("header"=>"East",    "title"=>"x_", "type"=>"textbox",  "width"=>"160px", "req_type"=>"rf", "readonly"=>false /*"readonly"=>true*/),      	 
		"boundary_south"  =>array("header"=>"South",    "title"=>"x_", "type"=>"textbox",  "width"=>"160px", "req_type"=>"rf", "readonly"=>false /*"readonly"=>true*/),      
		"boundary_west"  =>array("header"=>"West",    "title"=>"x_", "type"=>"textbox",  "width"=>"160px", "req_type"=>"rf", "readonly"=>false /*"readonly"=>true*/),      	 
        "enabled"  =>array("header"=>"Enabled",    "title"=>"x_", "type"=>"checkbox",  "width"=>"160px",  "readonly"=>false, "view_type"=>"checkbox", "true_value"=>1, "false_value"=>0),
	...
	"edit"     =>array("view"=>1, "edit"=>1,  "type"=>"link", "byFieldValue"=>""),
    "cancel"  =>array("view"=>true, "edit"=>true,  "type"=>"link"),
    "delete"  =>array("view"=>true, "edit"=>true,  "type"=>"image")
 );
$dgrid->setModes($modes);
